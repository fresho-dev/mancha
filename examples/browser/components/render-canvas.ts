import type { IRenderer } from "../../../src/renderer.js";

// This module is loaded via the :render attribute and initializes the canvas element.
export default function (elem: HTMLCanvasElement, renderer: IRenderer) {
